from git_metrics_release_lead_time import parse_tags_with_author_date
...
def test_parse_tags_with_author_date():
    out = parse_tags_with_author_date(["refs/tags/VER-1.0.0 18298732"])
